...
const L = "/portfolio/viride-energy-africa/live"; // e.g. "/portfolio/viride-energy-africa/live"

const browsePages = [
  { src: `${L}/viride-energy-africa-homepage.jpg`, url: "viridenergy.com" },
  { src: `${L}/viride-energy-africa-about.jpg`, url: "viridenergy.com/about-us/" },
  { src: `${L}/viride-energy-africa-services.jpg`, url: "viridenergy.com/tyre-recycling/" },
];

const mobileShots = [`${L}/viride-energy-africa-homepage-mobile.jpg`, `${L}/viride-energy-africa-about-mobile.jpg`];
        ...
        <div className="container-wide relative z-10 pb-16">
          ...
          <div className="grid gap-10 lg:grid-cols-[minmax(0,0.78fr)_minmax(420px,1.08fr)] lg:items-end">
            ...
            <ProjectHeroPreview
              ...
              url={project.liveUrl ?? "viridenergy.com"}
              scroll
              priority
            />
          </div>
