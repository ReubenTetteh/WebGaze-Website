...
const L = "/portfolio/petra-care-services/live"; // e.g. "/portfolio/petra-care-services/live"

const browsePages = [
  { src: `${L}/petra-care-services-homepage.jpg`, url: "petracare.com.au" },
  { src: `${L}/petra-care-services-about.jpg`, url: "petracare.com.au/about-us" },
  { src: `${L}/petra-care-services-services.jpg`, url: "petracare.com.au/services" },
];

const mobileShots = [`${L}/petra-care-services-homepage-mobile.jpg`, `${L}/petra-care-services-about-mobile.jpg`];

const project = getProject("petra-care-services");
        ...
        <div className="container-wide relative z-10 pb-16">
          ...
          <div className="grid gap-10 lg:grid-cols-[minmax(0,0.78fr)_minmax(420px,1.08fr)] lg:items-end">
            ...
            <ProjectHeroPreview
              ...
              url={project.liveUrl ?? "petracare.com.au"}
              scroll
              priority
            />
          </div>
