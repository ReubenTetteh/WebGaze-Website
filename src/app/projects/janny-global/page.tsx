...
const L = "/portfolio/janny-global/live"; // e.g. "/portfolio/janny-global/live"

const browsePages = [
  { src: `${L}/janny-global-homepage.jpg`, url: "jannyglobal.com" },
  { src: `${L}/janny-global-about.jpg`, url: "jannyglobal.com/about" },
  { src: `${L}/janny-global-services.jpg`, url: "jannyglobal.com/consultancy-and-advisory-solutions" },
];

const mobileShots = [`${L}/janny-global-homepage-mobile.jpg`, `${L}/janny-global-about-mobile.jpg`];

const project = getProject("janny-global");
        ...
        <div className="container-wide relative z-10 pb-16">
          ...
          <div className="grid gap-10 lg:grid-cols-[minmax(0,0.78fr)_minmax(420px,1.08fr)] lg:items-end">
            ...
            <ProjectHeroPreview
              ...
              url={project.liveUrl ?? "jannyglobal.com"}
              scroll
              priority
            />
          </div>
