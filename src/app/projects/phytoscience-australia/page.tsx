...
const browsePages = [
  { src: "/portfolio/phyto/live/phytoscience-australia-homepage.jpg", url: "phytoscienceaustralia.com.au" },
  { src: "/portfolio/phyto/live/phytoscience-australia-about.jpg", url: "phytoscienceaustralia.com.au/about" },
  { src: "/portfolio/phyto/live/phytoscience-australia-services.jpg", url: "phytoscienceaustralia.com.au/services" },
];

const mobileShots = [
  "/portfolio/phyto/live/phytoscience-australia-homepage-mobile.jpg",
  "/portfolio/phyto/live/phytoscience-australia-about-mobile.jpg",
];
...
export default function PhytoScienceProjectPage() {
  if (!project) {
    return null;
  }
        ...
        <div className="container-wide relative z-10 pb-16">
          ...
          <div className="grid gap-10 lg:grid-cols-[minmax(0,0.78fr)_minmax(420px,1.08fr)] lg:items-end">
            ...
            <ProjectHeroPreview
              ...
              url={project.liveUrl ?? "phytoscienceaustralia.com.au"}
              scroll
              priority
            />
          </div>
      ...
      <section className="bg-white py-16 dark:bg-dark-bg md:py-24">
        <div className="container-wide">
          <div className="grid gap-12 lg:grid-cols-[minmax(0,1.15fr)_minmax(0,0.85fr)] lg:gap-16">
            {/* More of the work — desktop carousel */}
            <div>
            ...
            {/* Just as clean on mobile — two static phones */}
            <div>
              <p className="mb-3 font-display text-xs font-bold uppercase tracking-[0.22em] text-red-brand">
                Responsive
              </p>
