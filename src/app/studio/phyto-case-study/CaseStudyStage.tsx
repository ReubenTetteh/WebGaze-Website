...
/* ------------------------------------------------------------------ */
/*  PhytoScience Australia — premium, light-led case study.            */
/*  Light-led body, neutral-dark hero/marquee/bookend, and WebGaze red */
/*  throughout (accents AND glows) to stay on house brand.             */
/*  Visuals are real captures of phytoscienceaustralia.com.au —        */
/*  homepage (full page), every inner page, and mobile.                */
/* ------------------------------------------------------------------ */

const project = getProject("phytoscience-australia")!;
const heroPreview = "/portfolio/phyto/live/phytoscience-australia-homepage-fullpage.jpg";
const L = "/portfolio/phyto/live";
...
const SCOPE =
  "A digital presence that finally matches the science — calm, credible, easy to move through.";

const VALUES = [
  { title: "Innovation", body: "Plant-science tech, surfaced as the headline.", icon: "spark" },
  { title: "Sustainability", body: "A lighter footprint, proven — never green-washed.", icon: "leaf" },
  { title: "Integrity", body: "High ethical standards, in a measured tone.", icon: "shield" },
  { title: "Collaboration", body: "Direct routes to a real scientist.", icon: "people" },
] as const;
...
const STEPS = [
  {
    n: "01",
    kicker: "Challenge",
    title: "Serious science, a forgettable site.",
    body: "World-class research, hidden behind a flat, template-feeling presence.",
  },
  {
    n: "02",
    kicker: "Approach",
    title: "Let the science lead, calmly.",
    body: "A confident system and a clear spine — values, mission, services, proof.",
  },
  {
    n: "03",
    kicker: "Outcome",
    title: "A brand that reads as a leader.",
    body: "Easy to explore, and simple for the team to extend.",
  },
];

// Their real service lines — the substance behind the brand.
const SERVICES = [
  { name: "Research & Development", note: "Facilities pushing plant science forward." },
  { name: "Health & Wellness Products", note: "Plant-derived supplements and skincare." },
  { name: "Sustainable Agriculture", note: "Higher yield, healthier soil." },
  { name: "Custom Formulation", note: "Bespoke plant-based formulations." },
  { name: "Consulting Services", note: "Phytochemistry expertise on tap." },
];

// Real inner pages — proof the whole site was designed, not just a homepage.
const PAGES = [
  { src: `${L}/phytoscience-australia-homepage.jpg`, label: "Homepage" },
  { src: `${L}/phytoscience-australia-about.jpg`, label: "About" },
  { src: `${L}/phytoscience-australia-services.jpg`, label: "Services" },
  { src: `${L}/phytoscience-australia-research.jpg`, label: "Research & Development" },
  { src: `${L}/phytoscience-australia-wellness.jpg`, label: "Health & Wellness" },
  { src: `${L}/phytoscience-australia-agriculture.jpg`, label: "Sustainable Agriculture" },
  { src: `${L}/phytoscience-australia-formulation.jpg`, label: "Custom Formulation" },
  { src: `${L}/phytoscience-australia-consulting.jpg`, label: "Consulting" },
  { src: `${L}/phytoscience-australia-sustainability.jpg`, label: "Sustainability" },
];
...
function ValueIcon({ name }: { name: (typeof VALUES)[number]["icon"] }) {
  ...
  return (
    <svg viewBox="0 0 24 24" className="h-6 w-6" stroke="currentColor" {...common} aria-hidden="true">
      ...
      {name === "leaf" && <path d="M5 19c0-8 6-13 14-13 0 8-5 14-13 14a8 8 0 0 1-1-1Zm0 0C8 14 11 11 16 9" />}
    ...
    <div className={`wgPause ${className}`}>
      <div className="relative overflow-hidden rounded-[2.4rem] border-[7px] border-[#15161a] bg-black shadow-[0_30px_70px_-28px_rgba(20,20,22,0.45)]">
        ...
        <div className="relative h-[500px] w-[244px] overflow-hidden">
          ...
          <img src={src} alt="PhytoScience on mobile" loading="lazy" decoding="async" className={`block w-full ${scroll ? "wgDeckP" : ""}`} />
        </div>
      </div>
    </div>
  );
    ...
    <section className="relative overflow-hidden pt-28 text-white md:pt-32" style={{ backgroundColor: INK }}>
      ...
      <div className="container-wide relative z-10 pb-16">
        ...
        <div className="grid gap-10 lg:grid-cols-[minmax(0,0.78fr)_minmax(420px,1.08fr)] lg:items-end">
          ...
          <ProjectHeroPreview src={heroPreview} alt="PhytoScience Australia website" url="phytoscienceaustralia.com.au" scroll priority />
        </div>
      </div>
    </section>
  );
...
export function PhytoCaseStudyStage() {
  ...
  return (
    <div className="bg-white text-[#141414]">
            ...
            <div className="grid items-end gap-8 lg:grid-cols-[1.1fr_0.9fr]">
              <Reveal>
                ...
                <h2 className="mt-5 max-w-[17ch] font-display text-[clamp(1.9rem,3.8vw,3.2rem)] font-bold leading-[1.06] tracking-[-0.03em]">
                  A digital presence that matches the science.
                </h2>
              </Reveal>
              <Reveal delay={0.1}>
          ...
          <div className="border-t border-black/8 pt-12 md:pt-16">
            <Reveal>
              ...
              <h2 className="mt-5 max-w-[22ch] font-display text-[clamp(1.7rem,3vw,2.6rem)] font-bold leading-[1.1] tracking-[-0.02em]">
                Four values, made <span className="text-red-brand">impossible to miss</span>.
              </h2>
            </Reveal>
          ...
          <div className="grid gap-10 border-t border-black/8 pt-12 md:pt-16 lg:grid-cols-2 lg:gap-14">
            ...
            <div>
              <Reveal>
                ...
                <h2 className="mt-5 max-w-[22ch] font-display text-[clamp(1.5rem,2.4vw,2.1rem)] font-bold leading-[1.12] tracking-[-0.02em]">
                  From overlooked to <span className="text-red-brand">unmistakably credible</span>.
                </h2>
              </Reveal>
              <Reveal delay={0.08}>
            ...
            <div>
              <Reveal>
                ...
                <h2 className="mt-5 max-w-[22ch] font-display text-[clamp(1.5rem,2.4vw,2.1rem)] font-bold leading-[1.12] tracking-[-0.02em]">
                  Five service lines, one clear path.
                </h2>
              </Reveal>
              <Reveal delay={0.08}>
        ...
        <div className="container-wide relative mb-9 flex flex-col items-start justify-between gap-4 md:flex-row md:items-end">
          ...
          <Reveal delay={0.1}>
            <p className="max-w-xs font-body text-sm leading-relaxed text-white/55">
              Nine pages — services, research, agriculture, sustainability — one calm system.
            </p>
          </Reveal>
        </div>
        ...
        <div className="container-wide relative">
          <div className="mx-auto max-w-2xl text-center">
            <Reveal>
              ...
              <h2 className="mt-5 font-display text-[clamp(1.8rem,3.2vw,2.8rem)] font-bold leading-[1.08] tracking-[-0.02em]">
                The same calm, right in their hand.
              </h2>
              <p className="mx-auto mt-4 max-w-md font-body text-base leading-relaxed text-[#555]">
                Most visitors arrive on a phone. Light, fast pages that keep the science front and centre.
              </p>
            </Reveal>
          </div>
          ...
          <Reveal delay={0.1}>
            <div className="mt-12 flex items-center justify-center">
              <PhoneDeck src={`${L}/phytoscience-australia-services-mobile.jpg`} className="hidden translate-x-10 translate-y-6 rotate-[-7deg] scale-[0.82] opacity-90 lg:block" />
              <PhoneDeck src={`${L}/phytoscience-australia-homepage-mobile.jpg`} scroll className="relative z-10" />
              <PhoneDeck src={`${L}/phytoscience-australia-about-mobile.jpg`} className="hidden -translate-x-10 translate-y-6 rotate-[7deg] scale-[0.82] opacity-90 lg:block" />
            </div>
          </Reveal>

          <div className="mx-auto mt-12 grid max-w-3xl grid-cols-1 gap-4 sm:grid-cols-3">
            {[
              ["Considered", "Clear hierarchy on every screen size."],
              ["Fast", "A lightweight build that loads quickly."],
              ["Effortless to update", "The team manages content without code."],
            ].map(([t, d], i) => (
      ...
      {/* 7 — RESULT + CTA (dark forest bookend) ------------------------ */}
        ...
        <div className="container-wide relative text-center">
          ...
          <Reveal delay={0.08}>
            <p className="mx-auto mt-6 max-w-[20ch] font-display text-[clamp(1.9rem,4.4vw,3.6rem)] font-bold leading-[1.05] tracking-[-0.03em]">
              A brand that finally reads like the science behind it.
            </p>
          </Reveal>
          <Reveal delay={0.16}>
            <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
              <a
                href="https://phytoscienceaustralia.com.au"
                target="_blank"
                rel="noreferrer"
