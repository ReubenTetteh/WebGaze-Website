...
/* ------------------------------------------------------------------ */
/*  Salaka Dance Ensemble — premium, light-led case study.             */
/*  Light-led body, neutral-dark hero/marquee/bookend, and WebGaze red */
/*  throughout (accents AND glows) to stay on house brand.             */
/*  Visuals are real captures of salakadance.org — homepage (full      */
/*  page), every inner page, and mobile.                               */
/* ------------------------------------------------------------------ */

const project = getProject("salaka-dance-ensemble")!;
const heroPreview = "/portfolio/salaka/live/salaka-dance-ensemble-homepage-fullpage.jpg";
const L = "/portfolio/salaka/live";
...
const SCOPE =
  "A home online with the colour, rhythm, and pride of the stage — and a clear path from first look to booked performance.";

// "Salaka" means sharing — the real spirit running through the ensemble.
const VALUES = [
  { title: "Sharing", icon: "people" },
  { title: "Heritage", icon: "leaf" },
  { title: "Mastery", icon: "spark" },
  { title: "Pride", icon: "shield" },
] as const;
...
const STEPS = [
  {
    n: "01",
    kicker: "Challenge",
    title: "Decades of acclaim, no home online.",
    body: "Performing for President Kufuor, leading Ghana's 50th independence — none of it carried by the old site.",
  },
  {
    n: "02",
    kicker: "Approach",
    title: "Let the performance lead.",
    body: "Vivid stage imagery, a clear spine through their story and four service lines, and a booking always within reach.",
  },
  {
    n: "03",
    kicker: "Outcome",
    title: "A site as alive as the ensemble.",
    body: "Easy for organisers, audiences, and partners worldwide to explore — and book.",
  },
];

// Their real service lines — the substance behind the brand.
const SERVICES = [
  { name: "International Tours & Performances", note: "Taking the rhythm of Ghana to stages worldwide." },
  { name: "Events & Entertainment", note: "Master drummers and dancers for corporate and private occasions." },
  { name: "Cultural Exchanges & Residencies", note: "Immersive programs into authentic Ghanaian music and dance." },
  { name: "Team Building", note: "Hands-on drumming workshops that bring groups together." },
];

// Real inner pages — proof the whole site was designed, not just a homepage.
const PAGES = [
  { src: `${L}/salaka-dance-ensemble-homepage.jpg`, label: "Homepage" },
  { src: `${L}/salaka-dance-ensemble-about.jpg`, label: "About Us" },
  { src: `${L}/salaka-dance-ensemble-services.jpg`, label: "What We Do" },
  { src: `${L}/salaka-dance-ensemble-tours.jpg`, label: "International Tours" },
  { src: `${L}/salaka-dance-ensemble-events.jpg`, label: "Events & Entertainment" },
  { src: `${L}/salaka-dance-ensemble-cultural.jpg`, label: "Cultural Exchanges" },
  { src: `${L}/salaka-dance-ensemble-gallery.jpg`, label: "Gallery" },
  { src: `${L}/salaka-dance-ensemble-video.jpg`, label: "Video Gallery" },
  { src: `${L}/salaka-dance-ensemble-book.jpg`, label: "Book Now" },
  { src: `${L}/salaka-dance-ensemble-contact.jpg`, label: "Contact" },
];
    ...
    <div className={`wgPause ${className}`}>
      <div className="relative overflow-hidden rounded-[2.4rem] border-[7px] border-[#15161a] bg-black shadow-[0_30px_70px_-28px_rgba(20,20,22,0.45)]">
        ...
        <div className="relative h-[500px] w-[244px] overflow-hidden">
          <Image src={src} alt="Salaka Dance Ensemble on mobile" width={488} height={1060} sizes="244px" className={`block h-auto w-full ${scroll ? "wgDeckP" : ""}`} />
        </div>
      </div>
    </div>
  );
    ...
    <section className="relative overflow-hidden pt-28 text-white md:pt-32" style={{ backgroundColor: INK }}>
      ...
      <div className="container-wide relative z-10 pb-16">
        ...
        <div className="grid gap-10 lg:grid-cols-[minmax(0,0.78fr)_minmax(420px,1.08fr)] lg:items-end">
          ...
          <ProjectHeroPreview src={heroPreview} alt="Salaka Dance Ensemble website" url="salakadance.org" scroll priority />
        </div>
      </div>
    </section>
  );
...
export function SalakaCaseStudyStage() {
        ...
        <div className="container-wide space-y-12 md:space-y-16">
          ...
          <div>
            <div className="grid items-end gap-8 lg:grid-cols-[1.1fr_0.9fr]">
              <Reveal>
                ...
                <h2 className="mt-5 max-w-[17ch] font-display text-[clamp(1.9rem,3.8vw,3.2rem)] font-bold leading-[1.06] tracking-[-0.03em]">
                  A stage presence, finally online.
                </h2>
              </Reveal>
              <Reveal delay={0.1}>
            ...
            <div className="mt-8 grid grid-cols-2 overflow-hidden rounded-2xl border border-black/10 md:grid-cols-4">
              {[
                ["Year", "2023"],
                ["Sector", "Performing Arts · Culture"],
                ["Based", "Nungua, Ghana"],
                ["Scope", "10 pages"],
              ].map(([k, v], i) => (
          ...
          <div className="grid gap-10 border-t border-black/8 pt-12 md:pt-16 lg:grid-cols-2 lg:gap-14">
            ...
            <div>
              <Reveal>
                ...
                <h2 className="mt-5 max-w-[22ch] font-display text-[clamp(1.5rem,2.4vw,2.1rem)] font-bold leading-[1.12] tracking-[-0.02em]">
                  From world stages to <span className="text-red-brand">a worthy home online</span>.
                </h2>
              </Reveal>
              <Reveal delay={0.08}>
            ...
            <div>
              <Reveal>
                ...
                <h2 className="mt-5 max-w-[22ch] font-display text-[clamp(1.5rem,2.4vw,2.1rem)] font-bold leading-[1.12] tracking-[-0.02em]">
                  Four service lines, one clear path.
                </h2>
              </Reveal>
              <Reveal delay={0.08}>
        ...
        <div className="container-wide relative mb-9 flex flex-col items-start justify-between gap-4 md:flex-row md:items-end">
          ...
          <Reveal delay={0.1}>
            <p className="max-w-xs font-body text-sm leading-relaxed text-white/55">
              Ten pages — story, services, gallery, bookings — all carrying the same energy.
            </p>
          </Reveal>
        </div>
        ...
        <div className="container-wide relative">
          <div className="mx-auto max-w-2xl text-center">
            <Reveal>
              ...
              <h2 className="mt-5 font-display text-[clamp(1.8rem,3.2vw,2.8rem)] font-bold leading-[1.08] tracking-[-0.02em]">
                The whole show, right in their hand.
              </h2>
              <p className="mx-auto mt-4 max-w-md font-body text-base leading-relaxed text-[#555]">
                Most visitors arrive on a phone. Vivid, fast pages that keep the performance — and the booking — front and centre.
              </p>
            </Reveal>
          </div>
          ...
          <Reveal delay={0.1}>
            <div className="mt-12 flex items-center justify-center">
              <PhoneDeck src={`${L}/salaka-dance-ensemble-gallery-mobile.jpg`} className="hidden translate-x-10 translate-y-6 rotate-[-7deg] scale-[0.82] opacity-90 lg:block" />
              <PhoneDeck src={`${L}/salaka-dance-ensemble-homepage-mobile.jpg`} scroll className="relative z-10" />
              <PhoneDeck src={`${L}/salaka-dance-ensemble-about-mobile.jpg`} className="hidden -translate-x-10 translate-y-6 rotate-[7deg] scale-[0.82] opacity-90 lg:block" />
            </div>
          </Reveal>

          <div className="mx-auto mt-12 grid max-w-3xl grid-cols-1 gap-4 sm:grid-cols-3">
            {[
              ["Expressive", "Colour and movement on every screen size."],
              ["Fast", "A lightweight build that loads quickly."],
              ["Easy to book", "A booking is always one tap away."],
            ].map(([t, d], i) => (
        ...
        <div className="container-wide relative text-center">
          ...
          <Reveal delay={0.08}>
            <p className="mx-auto mt-6 max-w-[20ch] font-display text-[clamp(1.9rem,4.4vw,3.6rem)] font-bold leading-[1.05] tracking-[-0.03em]">
              A home as alive as the ensemble itself.
            </p>
          </Reveal>
          <Reveal delay={0.16}>
            <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
              <a
                href="https://salakadance.org"
                target="_blank"
                rel="noreferrer"
