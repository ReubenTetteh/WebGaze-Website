...
const services = [
  ...
  },
  {
    id: "systems",
    num: "02",
    label: "AI & Custom Systems",
    title: "AI & Custom Business Systems",
    headline: "Solve the Work Your Business Keeps Doing By Hand.",
    body: [
      "We build custom systems, internal tools, automations, and AI-assisted apps around the way your business actually works.",
      "That could be a learning platform, a fleet tracker, a chat app, a reporting dashboard, an intake system, or a practical workflow that removes hours of manual work from your week.",
    ],
    tags: ["Custom Tools", "AI Solutions", "Automation", "Internal Apps"],
    features: [
      "Custom internal tools & dashboards",
      "Workflow automation",
      "AI assistants where it counts",
      "Learning platforms and portals",
      "Tracking, reporting, and record systems",
