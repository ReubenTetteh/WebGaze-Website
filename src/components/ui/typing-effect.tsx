...
/**
 * Rotating typewriter: types each string, holds, clears, types the next.
 * Adapted to project conventions (shared `cn`, `framer-motion` import).
 */
export const TypingEffect = ({
  ...
  }, [charIndex, currentText, isInView, rotationInterval, texts.length, typingSpeed]);
